...
public class RestaurantService {
  ...
  public ResponseEntity<RestaurantModel> createRestaurant(@RequestBody RestaurantModel rm) {
    try {
      ...
      RestaurantModel _restaurant =
          restaurantRepository.save(new RestaurantModel(rm.getRestaurantName(), rm.getAddress(),
  ...
  public ResponseEntity<RestaurantModel> updateRestaurant(@PathVariable int id,
      @RequestBody RestaurantModel resmodel) {
    Optional<RestaurantModel> restData = restaurantRepository.findById(id);
    if (restData.isPresent()) {
